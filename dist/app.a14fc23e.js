...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function drumMachine(e) {
    ...
    var key = document.querySelector('li.key[data-key="' + e.keyCode + '"]');
    console.log(e);
    ...
    var keys = [].concat(_toConsumableArray(document.querySelectorAll('li.key'))).map(function (key) {
